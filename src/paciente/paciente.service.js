...
var PacienteService = function () {
    ...
    var PacienteService = _classThis = /** @class */ (function () {
        function PacienteService_1(prisma) {
            this.prisma = prisma;
        }
        PacienteService_1.prototype.remove = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.paciente.delete({
                                where: {
                                    id: Number(id),
                                },
                            })];
        ...
        PacienteService_1.prototype.update = function (id, data) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
