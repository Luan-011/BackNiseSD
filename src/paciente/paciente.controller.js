...
var PacienteController = function () {
    var _classDecorators = [(0, common_1.UseGuards)(guard_1.JwtGuard), (0, common_1.Controller)('paciente')];
    ...
    var PacienteController = _classThis = /** @class */ (function () {
        ...
        PacienteController_1.prototype.getMe = function (user) {
            return user;
        };
        PacienteController_1.prototype.remove = function (paciente, id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.PacienteService.remove(id)];
                });
            });
        };
        PacienteController_1.prototype.update = function (id, data) {
            return __awaiter(this, void 0, void 0, function () {
                var pacienteId;
                return __generator(this, function (_a) {
                    pacienteId = parseInt(id, 10);
                    return [2 /*return*/, this.PacienteService.update(pacienteId, data)];
                });
            });
        };
